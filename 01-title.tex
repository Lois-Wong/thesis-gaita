...
\ThesisTitle{GAITA: A RAG SYSTEM FOR PERSONALIZED COMPUTER SCIENCE EDUCATION}

\vspace{1in}                    % gap between the title and the author: approx. 1 inch

\ThesisAuthor{Lois Wong}         % author name for the thesis
...
\ThesisStatement{thesis project}{Master of Science in Engineering}  
%% gap between statement and location: approx. 0.5 inch
\vspace{0.5in} \\               

\Location \\                    % prints Baltimore, Maryland as the location
\ThesisDate{December}{2024}        % thesis submission month and year (single-spaced)
...
\ThesisCopyright{2024}{Lois Wong}
