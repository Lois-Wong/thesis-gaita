...
%     date=year, isbn=false, url=false, doi=true]{biblatex} %% Lois switched style to numeric


\usepackage[backend=biber, defernumbers=true, style=numeric, maxnames=99,
...
%\addbibresource{\BibFileName}           % name of the bib file  %% lois changed here


\usepackage[style=apa]{biblatex} % Feel free to change the style to another one you prefer
\addbibresource{zreferences.bib}
...
%
%\mylistoftables     lois rm                       % MUST: if you have tables
%
...
\include{111-appendix-A}
\include{112-appendix-B}
